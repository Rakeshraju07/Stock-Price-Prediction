...
st.set_page_config("Real Time Stock Dashboard",page_icon="📈",layout="wide")
##########################################################################################
...
def add_technical_indicators(data):
    ...
    print(f"Shape of data['Close']: {data['Close'].shape if hasattr(data['Close'], 'shape') else 'No shape attribute'}")

    # Convert to explicit 1D Series
